...
4. **Final fallback - fetch normal page:**
   - If no llms.txt or .md found, WebFetch the official docs page directly

## Parallel Execution Rules

- When looking up multiple libraries, start ALL resolve-library-id calls simultaneously
